...
#for decoder in ["eegnet"]: #"eegnet", 
print(f"Processing {dataset} with {decoder}!")
#if decoder == "eegnet":
model_folder = "/ptmp/kroma/m4d/models/" + decoder
#elif decoder == "sliding":
...
concatenated_data.to_csv(os.path.join("/u/kroma/m4d/models/", f"{decoder}_extended.csv"), index=False)
